...
public class ProductCreateDtoValidator : AbstractValidator<ProductCreateDto>
{
    ...
    private void ValidateSpecs(ProductCreateDto dto, dynamic context)
    {
    ...
    private void ValidateJsonSpec<T>(ProductCreateDto dto, dynamic context, IValidator<T> validator)
        where T : class
    {
        try
        {
